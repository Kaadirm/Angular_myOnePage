...
// NOT: pipeline ngFor içinde çağırırken: one-page-blog-page.compontent.html (searchBlogFilter) bu isimle eklenir
@Pipe({
  // Pipe Adı
  name: 'searchBlogFilter',

  // Bu componenti bağımsız kullanabilelim.
  standalone: true
})
...
export class SearchBlogFilterPipe implements PipeTransform {
  ...
  // eğer dataFilterBlogCategory parametrede veri varsa bir takım filterlamalar yap
